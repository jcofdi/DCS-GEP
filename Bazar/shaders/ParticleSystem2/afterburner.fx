...
// =============================================================================
// ATMOSPHERIC / TIME-OF-DAY HELPERS (modded)
//
// These functions approximate how air density, altitude, and sun position
// should affect afterburner appearance. They use variables already available
...
{
	return max(0.0, World._42);
}

// Standard atmosphere density approximation.
// Returns 1.0 at sea level, ~0.31 at 10 km, ~0.097 at 20 km.
float getAtmosphericDensityFactor()
{
...
#if 0 //TODO: high-quality path (disabled in default)
	if(bHotAir)
	{
