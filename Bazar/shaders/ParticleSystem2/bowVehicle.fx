...
// [MOD] Issue S6: Uncommented and enabled proper lighting for vehicle bow wave.
// The original returned flat unlit gBaseColor — no sun, no ambient, no atmosphere,
// no shadows. This made vehicle bow waves appear as a constant-brightness overlay
// that didn't respond to time of day, weather, or lighting conditions.
// Now uses the existing shading infrastructure (ambient + sun + atmosphere + halo)
// that was already computed but commented out.
...
#define inUV           i.params1.xy
	...
	// [MOD] Enabled proper shading — was previously outputting flat gBaseColor.
