...
-- =============================================================================
-- GEP SunDiffuse: Physical chromaticity from ARPC CIE 2006 transmittance
-- =============================================================================
-- Stock table preserved as comment for reference:
--   {-1.000, 0.000, 0.000, 0.000}
--   {-0.045, 0.000, 0.000, 0.000}
--   { 0.002, 0.339, 0.264, 0.263}  -- ~4200K (too blue by ~2600x in B)
--   { 0.055, 0.749, 0.602, 0.502}  -- ~4800K (too blue by ~33x in B)
--   { 0.600, 1.000, 1.000, 0.803}  -- ~6200K (too blue by ~1.3x)
--   { 1.000, 1.000, 1.000, 1.000}  -- ~6504K (D65, ~580K too cool)
-- =============================================================================
SunDiffuse =
{
	{-1.000, 0.000, 0.000, 0.000};  
	{-0.045, 0.000, 0.000, 0.000};  
	{-0.010, 0.564, 0.124, 0.001};  
	{ 0.000, 0.738, 0.155, 0.001};  
	{ 0.002, 0.744, 0.170, 0.002};  
	{ 0.010, 0.771, 0.235, 0.005};  
	{ 0.020, 0.795, 0.318, 0.015};  
	{ 0.040, 0.899, 0.466, 0.053};  
	{ 0.055, 0.980, 0.574, 0.098};  
	{ 0.080, 0.914, 0.610, 0.160};  
	{ 0.100, 0.885, 0.633, 0.208};  
	{ 0.150, 0.856, 0.677, 0.312};  
	{ 0.200, 0.855, 0.715, 0.396};  
	{ 0.342, 0.905, 0.814, 0.573};  
	{ 0.500, 0.989, 0.919, 0.722};  
	{ 0.600, 1.000, 0.941, 0.769};  
	{ 0.800, 1.000, 0.955, 0.821};  
	{ 1.000, 1.000, 0.964, 0.854};  
};
